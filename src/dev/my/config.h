...
#define FANTIES_BASE_CELL 		1		// Base sprite cell (0, 1, 2 or 3)
...
#define TIMER_REFILL				99		// Timer refill, using tile 21 (hotspot #5)
#define TIMER_LAPSE					55		// # of frames between decrements
...
#define LINE_OF_TEXT				2		// If defined, scripts can show text @ Y = #
#define LINE_OF_TEXT_X				1		// X coordinate.
#define LINE_OF_TEXT_ATTR			70		// Attribute
...
#define PLAYER_MAX_VY_CAYENDO		256		// Max falling speed 
#define PLAYER_G					96		// Gravity acceleration 

#define PLAYER_VY_INICIAL_SALTO		128 	// Initial junp velocity 
#define PLAYER_MAX_VY_SALTANDO		384 	// Max jump velocity 
#define PLAYER_INCR_SALTO			32		// acceleration while JUMP is pressed 
...
#define PLAYER_AX					96		// Acceleration (24/64 = 0,375 p?xels/frame^2)
...
unsigned char behs [] = {
	0, 4, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 0, 1, 0,10,
